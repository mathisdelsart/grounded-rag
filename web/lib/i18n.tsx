...
const en = {
  ...
  "doc.upload.openaiKey": "Your OpenAI API key (optional)",
  "doc.upload.openaiKeyHint":
    "The same key as in the account menu. When set it powers every answer with a premium OpenAI model AND reads scanned/image PDFs — it replaces the free model and uses your OpenAI credit. Stored in your browser only; never on our server. Text PDFs and .md/.txt files import for free without a key.",
  "doc.upload.showKey": "Show key",
  "doc.upload.hideKey": "Hide key",
  "settings.openaiKey.label": "Your OpenAI API key (optional)",
  "settings.openaiKey.note":
    "Use your own OpenAI key for higher-quality answers everywhere — Ask, Re-explain, Exercise, Quiz and grading. This replaces the free model and uses your OpenAI credit. Stored only in your browser; sent only with your requests.",
  "settings.openaiKey.show": "Show key",
  "settings.openaiKey.hide": "Hide key",
  "settings.openaiKey.badge": "Premium model",
  "settings.openaiKey.badgeTitle": "Your OpenAI key is active — answers use a premium OpenAI model instead of the free one.",
...
const fr: Record<TranslationKey, string> = {
  ...
  "doc.upload.openaiKey": "Votre clé API OpenAI (optionnel)",
  "doc.upload.openaiKeyHint":
    "La même clé que dans le menu du compte. Lorsqu’elle est définie, elle alimente chaque réponse avec un modèle OpenAI premium ET permet de lire les PDF scannés ou basés sur des images : elle remplace le modèle gratuit et utilise votre crédit OpenAI. Conservée uniquement dans votre navigateur, jamais sur notre serveur. Les PDF texte et les fichiers .md/.txt s’importent gratuitement, sans clé.",
  "doc.upload.showKey": "Afficher la clé",
  "doc.upload.hideKey": "Masquer la clé",
  "settings.openaiKey.label": "Votre clé API OpenAI (optionnel)",
  "settings.openaiKey.note":
    "Utilisez votre propre clé OpenAI pour des réponses de meilleure qualité partout — Poser, Ré-expliquer, Exercice, Quiz et correction. Elle remplace le modèle gratuit et utilise votre crédit OpenAI. Conservée uniquement dans votre navigateur ; envoyée seulement avec vos requêtes.",
  "settings.openaiKey.show": "Afficher la clé",
  "settings.openaiKey.hide": "Masquer la clé",
  "settings.openaiKey.badge": "Modèle premium",
  "settings.openaiKey.badgeTitle": "Votre clé OpenAI est active — les réponses utilisent un modèle OpenAI premium au lieu du modèle gratuit.",
...
const nl: Record<TranslationKey, string> = {
  ...
  "doc.upload.openaiKey": "Uw OpenAI API-sleutel (optioneel)",
  "doc.upload.openaiKeyHint":
    "Dezelfde sleutel als in het accountmenu. Wanneer ingesteld, voedt hij elk antwoord met een premium OpenAI-model ÉN leest hij gescande of op afbeeldingen gebaseerde PDF’s — hij vervangt het gratis model en gebruikt uw OpenAI-tegoed. Alleen opgeslagen in uw browser, nooit op onze server. Tekst-PDF’s en .md/.txt-bestanden worden gratis geïmporteerd, zonder sleutel.",
  "doc.upload.showKey": "Sleutel tonen",
  "doc.upload.hideKey": "Sleutel verbergen",
  "settings.openaiKey.label": "Uw OpenAI API-sleutel (optioneel)",
  "settings.openaiKey.note":
    "Gebruik uw eigen OpenAI-sleutel voor betere antwoorden overal — Vraag, Opnieuw uitleggen, Oefening, Quiz en beoordeling. Dit vervangt het gratis model en gebruikt uw OpenAI-tegoed. Alleen opgeslagen in uw browser; alleen verzonden met uw verzoeken.",
  "settings.openaiKey.show": "Sleutel tonen",
  "settings.openaiKey.hide": "Sleutel verbergen",
  "settings.openaiKey.badge": "Premium-model",
  "settings.openaiKey.badgeTitle": "Uw OpenAI-sleutel is actief — antwoorden gebruiken een premium OpenAI-model in plaats van het gratis model.",
